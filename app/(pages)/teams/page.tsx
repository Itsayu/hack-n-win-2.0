...
const team: Mentor[] = [
  {
    ...
    connect:
      "https://www.linkedin.com/in/dhairya-ahuja-1b3b74286?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  },
  {
    name: "Ayush Anshu",
  ...
  },
  {
    ...
    connect:
      "https://www.linkedin.com/in/cloudmukul?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  },
  {
    name: "Qazi Zaid",
  ...
  },
  {
    ...
    connect:
      "https://www.linkedin.com/in/bijjam-madhana-bhargav-reddy-087806249",
  },
  {
    name: "Himanshu Verma ",
    expertise: "Video editor ",
    designation: "Video Editing",
    bio: "I'm Himanshu, and I'm a passionate video editor. With over an year of experience in the field, I've honed my skills to bring visuals to life and Bringing creativity and technical expertise to every frame via creating engaging stories through the power of video.",
    image: "/team/himanshu.png",
    connect:
      "https://www.linkedin.com/in/himanshu-verma-570465278?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  },

  {
    ...
    connect: "https://www.linkedin.com/in/yashika-mukhija/",
  },
        ...
        {selectedTeam && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
            <div className="bg-white rounded-lg shadow-lg max-w-3xl w-full p-8 relative">
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    {selectedTeam.designation} | {selectedTeam.expertise}
                  </p>
                  <a
                    href={selectedTeam.connect}
                    target="_blank"
              ...
              <p className="mt-6 text-gray-700 text-[16px]">
                {selectedTeam.bio}
              </p>
